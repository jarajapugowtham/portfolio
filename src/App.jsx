...
const profileImage = "/src/profile.jpg";
...
const projects = [
  ...
  },
  {
    ...
    tags: ["React", "JavaScript", "UI", "Healthcare"],
  },
  {
    number: "03",
...
function App() {
  ...
  const handleResume = () => {
    alert(
      "Resume link can be connected here. Add your Resume.pdf to the project and replace this function with its path."
    );
  };
      ...
      <main>
        ...
        <section className="section hero" id="home">
          <div className="hero-copy reveal">
            ...
            <h2>
              MERN STACK <i>|</i> REACT.JS <i>|</i> NODE.JS
            </h2>

            <p className="hero-text">
              BCA student and aspiring Software Developer building responsive
              full-stack web applications with React.js, Node.js, Express.js,
          ...
          <div className="hero-visual reveal">
            ...
            <div className="floating-tag tag-one">
              <MapPin size={10} /> VISAKHAPATNAM, INDIA
            </div>

            <div className="floating-tag tag-two">
              <Code2 size={10} /> OPEN TO OPPORTUNITIES
            </div>
          </div>
        </section>
        ...
        <section className="section" id="about">
          ...
          <div className="about-grid">
            <div className="panel about-copy reveal">
              <p>
                I'm <strong>Jarajapu Gowtham</strong>, a BCA student and
                aspiring Software Developer focused on creating responsive,
              ...
              <p>
                I work mainly with the MERN stack and enjoy connecting frontend
                interfaces with backend APIs, databases and authentication
                systems. My goal is to continuously improve my development
                skills and become a strong industry-ready software developer.
              </p>
              ...
              <div className="mini-facts">
                ...
                <div>
                  <GraduationCap />
                  <b>Education</b>
                  <span>BCA — Aditya Degree College</span>
                </div>
  ...
  goal:
    "Build useful software."
            ...
            {projects.map((project) => (
              ...
              >
                <div className={`project-art ${project.className}`}>
                  ...
                  {project.visual === "apsche" && (
                    <>
                      <div className="screen">
                        <b>APSCHE</b>
                        <small>Practice Portal</small>
                        <em>STUDENT COUNSELLING SYSTEM</em>
                      </div>
                      <div className="desk-shape" />
                    </>
                  )}

                  {project.visual === "pharma" && (
                    <>
                      <div className="pharma-cross">+</div>
            ...
            <div className="panel timeline-panel reveal">
              <div className="timeline">
                <div className="timeline-item">
                  ...
                  <div>
                    ...
                    <ul>
                      ...
                      <li>
                        Applied responsive UI and database integration.
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="timeline-item">
                  ...
                  <div>
                    <div className="item-top">
                      <h3>Visakhapatnam Port Trust</h3>
                      <span>
                        <CalendarDays size={11} />
                        2023
                      </span>
                    ...
                    <small>INTERNSHIP / EXPOSURE</small>

                    <p>
                      Gained practical exposure to enterprise workflows,
                      structured documentation and professional organizational
                      processes.
                    </p>
                  </div>
                </div>
              ...
              <div className="timeline">
                <div className="timeline-item">
                  ...
                  <div>
                    ...
                    <p>
                      BCA student with a strong interest in software
      ...
      <footer>
        ...
        <div>
          SOFTWARE DEVELOPER • MERN STACK • REACT.JS
        </div>
